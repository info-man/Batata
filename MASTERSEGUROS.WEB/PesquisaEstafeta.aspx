<%@ Page Title="Estafetas" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PesquisaEstafeta.aspx.cs" Inherits="MASTERSEGUROS.WEB.PesquisaEstafeta" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h3>Clientes > Pesquisa de Estafetas</h3>
    <br />
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server"> 
        <ContentTemplate>  
            ...
            <table border="0" cellpadding="1" cellspacing="0"   style="vertical-align: top;width:100%;border-collapse:collapse;font-size: 14px;">
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="CAPIDTextBox" runat="server"  Width="398" MaxLength="400" />
                ...
                <tr>
                 ...
                 <tr>
                    <td>Matrícula:</td>
                    <td>
                        <asp:TextBox ID="BITextbox" runat="server"  Width="200" MaxLength="200" />
        ...
        <br />
        <b>Tem a certeza que pretende remover o Cliente?</b>
    </div>
    ...
    <asp:GridView ID="GridViewMilitante" runat="server"
        ...
        <Columns>
            <asp:BoundField DataField="MilitanteID" HeaderText="Nr. Cliente" SortExpression="MilitanteID" ItemStyle-Width="70px" />
            <asp:BoundField DataField="Nome" HeaderText="Nome" SortExpression="Nome" ItemStyle-Width="200px"/>
            <asp:BoundField DataField="BI" HeaderText="NIF" SortExpression="BI" />
            ...
            <asp:TemplateField HeaderText="Estado" SortExpression="Estado" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="50px">
             ...
             <asp:TemplateField HeaderText="Operações" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate>
                    <asp:DropDownList runat="server" ID="ddlOperation" AutoPostBack="true"   AppendDataBoundItems="true" Font-Size="12px"  IDCliente='<%#(object)Eval("MilitanteID")%>'  OnSelectedIndexChanged="Operation_SelectedIndexChanged" >
