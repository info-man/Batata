<%@ Page Title="Simulação de Seguro de Frota"  Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AdminSimulacaoFrota.aspx.cs"  Async="true" Inherits="MASTERSEGUROS.WEB.AdminSimulacaoFrota"  %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server" EnablePartialRendering="true" EnablePageMethods="true" EnableCdn="true"/>
  <div id="aa" style="display:none">
    ...
    <asp:FormView ID="FormView1" runat="server"   Width="100%" DataKeyNames="PropostaID" DataSourceID="SqlDataSourcePropostaAutoFrota" DefaultMode="Insert" >
        <InsertItemTemplate>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0"   style="width:100%;border-collapse:collapse;font-size: 13px;">
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                &nbsp;<asp:RequiredFieldValidator ID="ReqValMatriculaTextBox" ValidationGroup="FormVeiculo" Display="Dynamic" runat="server"  ControlToValidate="MatriculaTextBox"  ToolTip="" SetFocusOnError="true">&otimes;</asp:RequiredFieldValidator><asp:RegularExpressionValidator runat="server" EnableClientScript="true" ControlToValidate="MatriculaTextBox"  ValidationGroup="FormVeiculo" Display="Dynamic" ValidationExpression="([A-Z]{2}-[0-9]{2}-[0-9]{2}-[A-Z]{2})|([A-Z]{3}-[0-9]{2}-[0-9]{2}-[A-Z]{2})">&otimes;</asp:RegularExpressionValidator>  &nbsp;(Ex:LD-00-00-AA ou LBB-00-00-XX)
                                          ...
                                          <td colspan="2">
                                              <table>
                                                  <td> 
                                                        ...
                                                        <asp:Button ID="btnActualizarAutomovelFrota"   ValidationGroup="FormVeiculo" CssClass="ui-button ui-corner-all" runat="server" Text="Actualizar" OnClick="btnActualizarAutomovelFrota_Click"  Visible="false" CausesValidation ="True"  />
                                                  ...
                                                  <td>
                                                      <asp:FileUpload ID="FileUpload1" runat="server"   ClientIDMode="Static" CssClass="ui-button ui-corner-all" onchange="this.form.submit()"/>
                                                  </td>
                                                  <td>
                                                  </td>
                                              </table>
                                           ...
                                           <td colspan="2">
                                                <asp:GridView ID="GridViewViaturas" runat="server"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="DataFabrico" HeaderText="Data Fabrico" SortExpression="DataFabrico" ItemStyle-Width="75px" />
    ...
    <div id="dialog-ArtigoErroGravar" title="Master Seguros" style="display: none">
     ...
     <div id="dialog-ErroEditar" title="Master Seguros" style="display: none">
        <br />
        Ocorreu um erro ao editar os dados.<br />Comunique ao administrador de sistemas.
         <input type="text" style="border-color:white;width:350px;text-align: left;" id="ErroEditar"  readonly="readonly" />
    </div>      
   ...
   <asp:SqlDataSource ID="SqlDataSourcePropostaAutoFrota"   OnInserted="On_Inserted" OnUpdated="On_Updated"  OnUpdating="On_Updating" OnInserting="On_Inserting" runat="server" ConnectionString="<%$ ConnectionStrings:DBConnectionString %>" 
   ...
   <script type="text/javascript">
    ...
    function () {
       ...
       function SetAllValidatorsSimulacao(bVal) {
           //Desabilitar/habilitar validators
           //document.getElementById("ctl00_MainContent_FormView1_ReqValNomeTextbox").enabled = bVal;
           document.getElementById("ctl00_MainContent_FormView1_ReqValMoradaTextbox").enabled = bVal;
           //document.getElementById("ctl00_MainContent_FormView1_ReqValDataInicioTextbox").enabled = bVal;
          // document.getElementById("ctl00_MainContent_FormView1_ReqValTelemovelTextbox").enabled = bVal;
...
/*
       ...
       function MessageBoxErroEditar(refString) {
           $("#ErroEditar").val(refString);
           $("#dialog-ErroEditar").dialog({
               title: "MASTER SEGUROS",
               resizable: false,
               width: 430,
               height: 200,
