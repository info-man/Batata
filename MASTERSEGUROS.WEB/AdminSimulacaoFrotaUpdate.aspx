<%@ Page Title="Simulação de Seguro de Frota"  Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AdminSimulacaoFrotaUpdate.aspx.cs" Inherits="MASTERSEGUROS.WEB.AdminSimulacaoFrotaUpdate"  %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server" EnablePartialRendering="true" EnablePageMethods="true" EnableCdn="true"/>
  <div id="aa" style="display:none">
    ...
    <asp:FormView ID="FormView1" runat="server"   Width="100%" DataKeyNames="PropostaID" DataSourceID="SqlDataSourcePropostaAutoFrota" DefaultMode="Edit" >
        <EditItemTemplate>
                             ...
                             <table border="0" cellpadding="0" cellspacing="0"   style="width:100%;border-collapse:collapse;font-size: 13px;">
                                ...
                                <tr>
                                 ...
                                 <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID="TelemovelTextBox"  Text='<%#Bind("Telemovel") %>'  runat="server"  Width="195" MaxLength="395" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                         <asp:HiddenField ID="h_DataInicioTextBox" runat="server"/>
                                        <asp:TextBox ID="DataInicioTextBox" Text='<%# Bind("DataInicio", "{0:dd/mm/yyyy}") %>'  runat="server"  Width="75" MaxLength="10"  /><img alt="Data de Início" src="images/31.png" style="vertical-align:text-bottom" />
                              ...
                              <h3>Dados do Veículo/Ocupantes/Danos Próprios/Tipo de Seguro</h3>
                              <div>
                                  ...
                                  <ContentTemplate>
                                    <table border="0" cellpadding="0" cellspacing="0"   style="width:100%;border-collapse:collapse;font-size: 13px;">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                    <asp:DropDownList Width="200" runat="server" ID="MarcaComboBox" AppendDataBoundItems="true" DataSourceID="MarcaDatasource" DataTextField="Descricao" DataValueField="MarcaID" OnSelectedIndexChanged="MarcaComboBox_SelectedIndexChanged" AutoPostBack="true" ValidationGroup="FormVeiculo" >
                                                        <asp:ListItem Value="" Text="Seleccione um opção"></asp:ListItem>
                                                    </asp:DropDownList>
                                                &nbsp;<asp:RequiredFieldValidator ID="ReqValMarcaComboBox" ValidationGroup="FormVeiculo" Display="Dynamic" runat="server" ControlToValidate="MarcaComboBox"  ToolTip="" SetFocusOnError="true">&otimes;</asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width:120px" >Modelo: <img alt="" style="vertical-align:middle" src="img/yes.png" /></td>
                                            <td>
                                                    <asp:DropDownList Width="200" runat="server" ID="ModeloComboBox" AppendDataBoundItems="true" DataSourceID="ModeloDatasource" DataTextField="Descricao" DataValueField="ModeloID" ValidationGroup="FormVeiculo" >
                                                       <asp:ListItem Value="" Text="Seleccione um opção"></asp:ListItem>
                                                    </asp:DropDownList>
                                                    &nbsp;<asp:RequiredFieldValidator ID="ReqValModeloComboBox" ValidationGroup="FormVeiculo" Display="Dynamic" runat="server" ControlToValidate="ModeloComboBox" ToolTip="" SetFocusOnError="true" >&otimes;</asp:RequiredFieldValidator>
                                         ...
                                         <tr>
                                            ...
                                            <td>
                                                 <asp:TextBox ID="DataFabricoTextBox" runat="server"  Text='<%#Bind("DataFabrico") %>' Width="75" MaxLength="10" ValidationGroup="FormVeiculo" /><img alt="Data de Fabrico" src="images/31.png" style="vertical-align:text-bottom" />&nbsp;
                                                &nbsp;<asp:RequiredFieldValidator ID="ReqValDataFabricoTextBox" ValidationGroup="FormVeiculo" Display="Dynamic" runat="server" Text="*" ControlToValidate="DataFabricoTextBox" ToolTip="" SetFocusOnError="true">&otimes;</asp:RequiredFieldValidator>
                                            </td>
                                        </tr>
                                         <tr>
                                            <td>Cilindrada: <img alt="" style="vertical-align:middle" src="img/yes.png" /></td>
                                            <td>
                                                <asp:TextBox ID="CilindradaTextBox" Text='<%#Bind("Cilindrada") %>'  runat="server"  Width="50" MaxLength="4" ValidationGroup="FormVeiculo"/>
                                                &nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator2" ValidationGroup="FormVeiculo" Display="Dynamic" runat="server" Text="*" ControlToValidate="CilindradaTextBox"  ToolTip="" SetFocusOnError="true">&otimes;</asp:RequiredFieldValidator>
                                                <asp:RangeValidator ValidationGroup="FormVeiculo" MaximumValue="10000" MinimumValue="0" ControlToValidate="CilindradaTextBox" ID="RangeValCilindradaTextBox" runat="server" Type="Integer">&otimes;</asp:RangeValidator>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID="LugaresTextBox" Text='<%#Bind("Lugares") %>'  runat="server"  Width="30" MaxLength="2" ValidationGroup="FormVeiculo"/>
                                                &nbsp;<asp:RequiredFieldValidator ID="RequiredFieldValidator3" ValidationGroup="FormVeiculo" Display="Dynamic" runat="server" Text="*" ControlToValidate="LugaresTextBox"  ToolTip="" SetFocusOnError="true">&otimes;</asp:RequiredFieldValidator>
                                                <asp:RangeValidator ValidationGroup="FormVeiculo" MaximumValue="60" MinimumValue="0" ControlToValidate="LugaresTextBox" ID="RageValLugaresTextBox" runat="server" Type="Integer">&otimes;</asp:RangeValidator>
                                     ...
                                     <table border="0" cellpadding="0" cellspacing="0"   style="width:100%;border-collapse:collapse;font-size: 13px;">
                                        <tr>
                                            <td style="width:150px" >Opção/Ocupantes:</td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                    <asp:TextBox ID="MIPDescTextBox" runat="server"  ReadOnly="true" Width="40" MaxLength="10" />&nbsp;<asp:TextBox ID="MIPValorTextBox" runat="server"  ReadOnly="true" Width="95" MaxLength="10" />
                                                    <asp:TextBox ID="DTDescTextBox" runat="server"  ReadOnly="true" Width="40" MaxLength="10" />&nbsp;<asp:TextBox ID="DTValorTextBox" runat="server" ReadOnly="true" Width="95" MaxLength="10"  />
                                                    <asp:TextBox ID="DFDescTextBox" runat="server"  ReadOnly="true" Width="40" MaxLength="10" />&nbsp;<asp:TextBox ID="DFValorTextBox" runat="server"  ReadOnly="true" Width="95" MaxLength="10"  />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="width:50px"></td>
                                  ...
                                  <table border="0" cellpadding="0" cellspacing="0"   style="width:100%;border-collapse:collapse;font-size: 13px;">
                                    <tr>
                                        <td style="width:150px">Valor em Novo: </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td style="width:150px" >Valor a Segurar: </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td style="width:150px" >Franquia:</td>
                                        <td>
                                    ...
                                    <tr>
                                          <td colspan="2">
                                              <br />
                                            <asp:Button ID="btnAdicionarAutomovelFrota"  ValidationGroup="FormVeiculo" CssClass="ui-button ui-corner-all" runat="server" Text="Adicionar" OnClick="btnAdicionarAutomovelFrota_Click" CausesValidation ="True"  />
                                            <asp:Button ID="btnActualizarAutomovelFrota"  CssClass="ui-button ui-corner-all" runat="server" Text="Actualizar" OnClick="btnActualizarAutomovelFrota_Click"  Visible="false" CausesValidation ="True"  />
                                            <asp:Button ID="btnCancelarAutomovelFrota"  CssClass="ui-button ui-corner-all" runat="server" Text="Cancelar" OnClick="btnCancelarAutomovelFrota_Click"  Visible="false" CausesValidation ="True"  />
                                            <hr />
                                            <br />
                                          </td>
                                      </tr>
                                       <tr>
                                           <td colspan="2">
                                                <asp:GridView ID="GridViewViaturas" runat="server"
                                                    AllowPaging="True" AutoGenerateColumns="False"
                                                    CellPadding="2" DataKeyNames="ViaturaID" 
                                                    ...
                                                    <Columns>
                                                        <asp:BoundField DataField="ViaturaID" HeaderText="Nº" SortExpression="ViaturaID" ItemStyle-Width="10px" ItemStyle-HorizontalAlign="Center"  />
                                                        <asp:BoundField DataField="Matricula" HeaderText="Matrícula" SortExpression="Matricula" ItemStyle-Width="80px" />
                                                         <asp:TemplateField HeaderText="Marca"  ItemStyle-HorizontalAlign="Left" ItemStyle-Width="110px">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblMarca" runat="server" Text='<%# BuildMarca((object)Eval("MarcaID"))%>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Modelo"  ItemStyle-HorizontalAlign="Left" ItemStyle-Width="110px">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblModelo" runat="server" Text='<%# BuildModelo((object)Eval("ModeloID"))%>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:BoundField DataField="DataFabrico" HeaderText="Data Fabrico" SortExpression="DataFabrico" ItemStyle-HorizontalAlign="Center" DataFormatString="{0:d}" htmlencode="false" ItemStyle-Width="75px" />
                                                        <asp:BoundField DataField="Cilindrada" HeaderText="Cilindrada" SortExpression="Cilindrada" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="65px" />
                                                        <asp:BoundField DataField="Lugares" HeaderText="Lugares" SortExpression="Lugares" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="50px" />
                                                        <asp:TemplateField HeaderText="Tipo de Categoria"  ItemStyle-HorizontalAlign="Left" ItemStyle-Width="210px">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblTipoCategoriaID" runat="server" Text='<%# BuildTipoCategoriaID((object)Eval("TipoCategoriaID"))%>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                         <asp:TemplateField HeaderText="Operações" ItemStyle-HorizontalAlign="Center">
                                                            <ItemTemplate>
                                                                <asp:DropDownList runat="server" ID="ddlOperation" AutoPostBack="true" style="font-family:Open Sans;font-size: 11px;padding: 0px;margin: 3px;" IDViatura='<%#(object)Eval("ViaturaID")%>' AppendDataBoundItems="true"  onchange="javascript:if (this.value=='0') {return false;} if (this.value=='5') {return ConfirmDeleteViatura(this);} else {true; }" OnSelectedIndexChanged="Operation_SelectedIndexChanged">
            ...
            <asp:Button ID="ListaAnexa" ValidationGroup="Form" CssClass="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" runat="server" Text="2.1 Lista Anexa" CausesValidation ="True"  Visible="false" OnClick="ListaAnexa_Click"  />
    ...
    <div id="dialog-confirmDeleteViatura" title="Master Seguros" style="display: none">
        <br />
        <b>Tem a certeza que prentende eliminar a viatura?</b>
    </div>
   ...
   <asp:SqlDataSource ID="SqlDataSourcePropostaAutoFrota"   OnInserted="On_Inserted" OnUpdated="On_Updated"  OnUpdating="On_Updating" runat="server" ConnectionString="<%$ ConnectionStrings:DBConnectionString %>" 
        DeleteCommand="DELETE FROM [master_proposta_auto] WHERE [PropostaID] = @PropostaID" 
        InsertCommand="INSERT INTO [master_proposta_auto] ([NumeroProposta], [BrokerID], [QualidadeTomadorID], [DataInicio], [Fraccionamento], [Nome], [Morada], [ProvinciaID], [Telemovel], [Email], [BI], [Passaporte], [UserIDCriacao], [DataCriacao], [Tipo]) VALUES (@NumeroProposta, @BrokerID,@QualidadeTomadorID, @DataInicio, @Fraccionamento,@Nome,@Morada,@ProvinciaID,@Telemovel,@Email,@BI,@Passaporte,@UserIDCriacao, @DataCriacao, @Tipo); SELECT @PropostaID = SCOPE_IDENTITY()" 
        SelectCommand="SELECT * FROM [master_proposta_auto] WHERE [PropostaID] = @PropostaID"  
        UpdateCommand="UPDATE [master_proposta_auto] SET  [BrokerID] = @BrokerID ,[QualidadeTomadorID] = @QualidadeTomadorID ,  [DataInicio] = @DataInicio, [Fraccionamento] = @Fraccionamento, [Nome] = @Nome,[Morada] = @Morada, [ProvinciaID] = @ProvinciaID, [Telemovel] = @Telemovel, [Email] = @Email, [BI] = @BI, [Passaporte] = @Passaporte, [UserIDActualizacao] = @UserIDActualizacao, [DataActualizacao] = @DataActualizacao WHERE PropostaID = @PropostaID">
        <UpdateParameters>
   ...
   <asp:SqlDataSource ID="SqlDataSourceCategoria" runat="server"
    ...
    <asp:SqlDataSource ID="SqlDataSourceAllTipoCategoria" runat="server"
        ConnectionString="<%$ ConnectionStrings:DBConnectionString %>"
   ...
   <asp:SqlDataSource ID="SqlDataSourceTipoCategoria" runat="server"
        ...
        SelectCommand="SELECT * FROM [master_tipo_categoria] WHERE CategoriaID=@CategoriaID">
         <SelectParameters>
            <asp:ControlParameter ControlID="ctl00$MainContent$FormView1$CategoriaComboBox" PropertyName="SelectedValue"  Name="CategoriaID" Type="Int32" DefaultValue="0" />
          </SelectParameters>
    </asp:SqlDataSource>

     <asp:SqlDataSource ID="SqlDataSourcePropostaAutoFrotaViatura" runat="server"
        ConnectionString="<%$ ConnectionStrings:DBConnectionString %>"
        SelectCommand="SELECT * FROM [master_proposta_auto_frota] WHERE [PropostaID]=@PropostaID">
         <SelectParameters>
            <asp:QueryStringParameter QueryStringField="prpID" Name="PropostaID" DefaultValue="0" />
          </SelectParameters>
    </asp:SqlDataSource>
   ...
   <asp:SqlDataSource ID="MarcaDatasource" runat="server"
     ...
     <asp:SqlDataSource ID="ModeloAllDatasource" runat="server"
        ConnectionString="<%$ ConnectionStrings:DBConnectionString %>"
        SelectCommand="SELECT * FROM [master_modelo_veiculo]"></asp:SqlDataSource>
   ...
   <script type="text/javascript">
       ...
       function SetInitialize() {
           ...
           if ($("#ctl00_MainContent_FormView1_DataInicioTextBox").val() != '')
           {
               $("#ctl00_MainContent_FormView1_DataInicioTextBox").datepicker("option", "dateFormat", "dd/mm/yy");
               $("#ctl00_MainContent_FormView1_DataInicioTextBox").datepicker();
               $("#ctl00_MainContent_FormView1_DataInicioTextBox").val($("#ctl00_MainContent_FormView1_DataInicioTextBox").val().substring(0,10))
           ...
           $("#dialog-ResultadoConverterApolice").dialog({
               ...
               buttons: {
                   "OK": function () {
                       ...
                       location.href = 'adminsimulacaofrota.aspx';
                       $(this).dialog("close");
                       return true;
                   }
               }
       ...
       function ConfirmDeleteViatura(obj) {
        $("#dialog-confirmDeleteViatura").dialog({
            title: "MASTER SEGUROS",
            resizable: false,
            width: 430,
            height: 200,
