<%@ Page Title="Log In" Language="C#"  AutoEventWireup="true"
    CodeBehind="Login.aspx.cs" Inherits="MASTERSEGUROS.WEB.Account.Login" %>
...
<form runat="server" method="post" id="FormUser">
	...
	<div id="wrapper">
		...
		<div id="wrappermiddle">
			...
			<h2>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Bem-vindo à MASTER SEGUROS</h2>
		...
		<div id="powered">
		<p><!--Desenvolvido por <a href="http://www.clickit.co.ao">ClickIT, Internet Solutions</a> & <a href="http://www.MwangoBrain.com">Mwango Brain</a>--></p>
		</div>
	</div>
</form>
</body>
