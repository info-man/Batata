<%@ Page Title="Register" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="Register.aspx.cs" Inherits="MASTERSEGUROS.WEB.Account.Register" %>
        ...
        <WizardSteps>
            <asp:CreateUserWizardStep ID="RegisterUserWizardStep" runat="server">
                <ContentTemplate>
                    ...
                    <p>
                        Utilize o formulário para criar um novo utilizador
                    </p>
                    <p>
                        É obrigatório o preenchimento de <%= Membership.MinRequiredPasswordLength %> carácteres.
                    </p>
                    ...
                    <div class="accountInfo">
                        <fieldset class="register">
                            ...
                            <p>
                                <asp:Label ID="ConfirmPasswordLabel" runat="server" AssociatedControlID="ConfirmPassword">Confirmar Palavra-Passe:</asp:Label>
                        ...
                        <p class="submitButton">
                            <asp:Button ID="CreateUserButton"  CssClass="botao" runat="server" CommandName="MoveNext" Text="Criar Utilizador" 
                                 ValidationGroup="RegisterUserValidationGroup"/>
                        </p>
                    </div>
                </ContentTemplate>
