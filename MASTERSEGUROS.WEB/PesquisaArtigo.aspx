<%@ Page Title="CMSCK - Gestor de Conteúdos" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PesquisaArtigo.aspx.cs" Inherits="MASTERSEGUROS.WEB.PesquisaArtigo" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
    <h3>Artigos > Pesquisa de Artigos</h3>
    <br />
    <asp:UpdatePanel ID="UpdatePanel2" runat="server"> 
        <ContentTemplate>  
            <table border="0" cellpadding="3" cellspacing="0" style="vertical-align: top">
                            <tr>
                                <td>ID Artigo:</td>
                                <td>
                                    <asp:TextBox ID="ArtigoIDTextBox" runat="server"  Width="30" MaxLength="4" />&nbsp;&nbsp;ID Classificador:&nbsp;<asp:TextBox ID="ClassificadorIDTextBox" runat="server" Width="30" MaxLength="4" />
                            ...
                            <tr>
                                <td>Autor:</td>
                                <td>
                                    <asp:TextBox ID="AutorTextBox" runat="server"  Width="398" MaxLength="400" />
                                </td>
                            </tr>
                            <tr>
                                <td>Data:</td>
                            ...
                            <tr>
                                ...
                                <td>
                                   ...
                                   <asp:DropDownList runat="server"  ID="EstadoComboBox" AutoPostBack ="false" AppendDataBoundItems="true" >
                                    ...
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;No Ar:
                                    <asp:DropDownList runat="server"  ID="VisivelSiteComboBox" AutoPostBack ="false" AppendDataBoundItems="true" >
                                        <asp:ListItem Value="-1" Text="" Selected="True"></asp:ListItem>
                                        <asp:ListItem Value="1" Text="Visível no Site" Selected="False"></asp:ListItem>  
                                        <asp:ListItem Value="0" Text="Invsível no Site" Selected="false"></asp:ListItem>                           
                                    </asp:DropDownList>
                                </td>
                            </tr>
            ...
            <div id="dialog-confirmDeleteArtigo" title="CMSCK" style="display: none">
        <br />
        <b>Tem a certeza que pretende remover o Artigo?</b>
    </div>

            <asp:GridView ID="GridViewArtigos" runat="server"
        AllowPaging="True" AutoGenerateColumns="False"
        CellPadding="2" DataKeyNames="ArtigoID,Lingua" DataSourceID="SqlDataSourceArtigo"
        ...
        <Columns>
            <asp:BoundField DataField="ArtigoID" HeaderText="ID" SortExpression="ArtigoID" ItemStyle-Width="50px" />
            ...
            <asp:TemplateField HeaderText="Estado" SortExpression="Estado" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="50px">
                <ItemTemplate>  
                    <asp:ImageButton runat="server" ID="imgEstado" OnClick="imgEstado_Click" Estado='<%#(object)Eval("Estado")%>' IDArtigo='<%#(object)Eval("ArtigoID")%>' IDLingua='<%#(object)Eval("Lingua")%>'  ImageUrl='<%# BuildEstado((object)Eval("Estado"))%>' ToolTip='<%# BuildToolTipEstado((object)Eval("Estado"),(object)Eval("Titulo"))%>' />
                </ItemTemplate>
             </asp:TemplateField>
             <asp:BoundField DataField="Titulo" HeaderText="Nome" SortExpression="Nome" />
             <asp:TemplateField HeaderText="Operações" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate>
                    <asp:DropDownList runat="server" ID="ddlOperation" AutoPostBack="true" IDArtigo='<%#(object)Eval("ArtigoID")%>' IDLingua='<%#(object)Eval("Lingua")%>' AppendDataBoundItems="true" Font-Size="12px"  onchange="javascript:if (this.value=='0') {return false;} if (this.value=='2') {return ConfirmDeleteArtigo(this);} else {true; }" OnSelectedIndexChanged="Operation_SelectedIndexChanged">
                        ...
                        <asp:ListItem Text="Secções" Value="5"></asp:ListItem>
                        <asp:ListItem Text="Pré-visualizar" Value="6"></asp:ListItem>
                    </asp:DropDownList>
                </ItemTemplate>
            </asp:TemplateField>
    ...
    <asp:SqlDataSource ID="SqlDataSourceArtigo" OnUpdated="On_Updated"  OnInserted="On_Inserted" runat="server"
        ConnectionString="<%$ ConnectionStrings:DBConnectionString %>"
        SelectCommandType="StoredProcedure" SelectCommand="spGetListArtigo">
       <SelectParameters>
           <asp:ControlParameter ControlID="ArtigoIDTextbox" PropertyName="Text" Name="ArtigoID" Type="Int32" DefaultValue="-1" />
           ...
           <asp:ControlParameter ControlID="AutorTextbox" PropertyName="Text" Name="Autor" DefaultValue="NULL" Type="string" />
           ...
           <asp:ControlParameter ControlID="VisivelSiteComboBox" PropertyName="SelectedValue" Name="VisivelSite" DefaultValue="-1" Type="Int32" />
       </SelectParameters>
    </asp:SqlDataSource>
    
   <asp:SqlDataSource ID="SqlDataSourceTipo" runat="server"
        ConnectionString="<%$ ConnectionStrings:DBConnectionString %>"
        SelectCommand="SELECT * FROM [cmsck_tipo_Artigo] "></asp:SqlDataSource>
...
<script type="text/javascript">
    ...
    function ConfirmDeleteArtigo(obj) {
        $("#dialog-confirmDeleteArtigo").dialog({
