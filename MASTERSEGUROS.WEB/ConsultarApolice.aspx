<%@ Page Title="Consultar Apólice"  Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ConsultarApolice.aspx.cs" Inherits="MASTERSEGUROS.WEB.ConsultarApolice"  %>
...
<asp:ScriptManager ID="ScriptManager1" runat="server" EnablePartialRendering="true" />
    ...
    <asp:FormView ID="FormView1" runat="server"   Width="100%" DataKeyNames="PropostaID" DataSourceID="SqlDataSourcePropostaAuto" DefaultMode="Insert" >
        ...
        <InsertItemTemplate>
                          ...
                          <div id="accordion">
                             ...
                             <table border="0" cellpadding="0" cellspacing="0"   style="width:100%;border-collapse:collapse;font-size: 13px;">
                                ...
                                <tr>
                                 ...
                                 <tr>
                                    <td>Telemóvel: <img alt="" style="vertical-align:middle" src="img/yes.png" /></td>
                                    <td>
                            ...
                            <table border="0" cellpadding="0" cellspacing="0"   style="width:100%;border-collapse:collapse;font-size: 13px;">
                              ...
                              <ContentTemplate>
                                <table border="0" cellpadding="0" cellspacing="0"   style="width:100%;border-collapse:collapse;font-size: 13px;">
                                    <tr>
                                        ...
                                        <td>
                                             <asp:TextBox ID="MatriculaTextBox" Text='<%#Bind("Matricula") %>'  runat="server"  Width="95" MaxLength="10"  />
                                            &nbsp;<asp:RequiredFieldValidator ID="ReqValMatriculaTextBox" ValidationGroup="Form" Display="Dynamic" runat="server"  ControlToValidate="MatriculaTextBox" ToolTip="" SetFocusOnError="true">&otimes;</asp:RequiredFieldValidator>
                                    ...
                                    <tr>
                                        <td>"Q" Cliente RC:</td>
                                        <td>
                                            <asp:TextBox ID="ClienteRCTextBox" Text='<%#Bind("ClienteRC") %>'  runat="server"  Width="30" MaxLength="4" Style="text-align:center" />
                                    ...
                                    <tr>
                                        <td>"Q" Cliente DP:</td>
                                        <td>
                                            <asp:TextBox ID="ClienteDPTextBox" Text='<%#Bind("ClienteDP") %>'  runat="server"  Width="30" MaxLength="4"  Style="text-align:center" />
                              ...
                              <div>
                                 ...
                                 <ContentTemplate>
                                  <table border="0" cellpadding="0" cellspacing="0"   style="width:100%;border-collapse:collapse;font-size: 13px;">
                                    <tr>
                                        <td style="width:120px">Valor em Novo: <img alt="" style="vertical-align:middle" src="img/yes.png" /></td>
                                        <td>
                                             <asp:TextBox ID="ValorNovoTextBox" Text='<%#Bind("ValorNovo") %>'  runat="server"  Width="95" MaxLength="10"  />
                                            &nbsp;<asp:RequiredFieldValidator ID="ReqValValorNovoTextBox" ValidationGroup="Form" Display="Dynamic" runat="server"  ControlToValidate="ValorNovoTextBox" ToolTip="" SetFocusOnError="true">&otimes;</asp:RequiredFieldValidator>
                                            <asp:RangeValidator ID="rngValValorNovoTextBox" ValidationGroup="Form" Display="Dynamic" runat="server" ControlToValidate="ValorNovoTextBox" ToolTip="" SetFocusOnError="true" Type="Double" MinimumValue="0" MaximumValue="50000000">&otimes;</asp:RangeValidator>

                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width:120px" >Valor a Segurar: <img alt="" style="vertical-align:middle" src="img/yes.png" /></td>
                                        <td>
                                                <asp:TextBox ID="ValorSegurarTextBox" Text='<%#Bind("ValorSegurar") %>'  runat="server"  Width="95" MaxLength="10"  />
                                            &nbsp;<asp:RequiredFieldValidator ID="ReqValValorSegurarTextBox" ValidationGroup="Form" Display="Dynamic" runat="server"  ControlToValidate="ValorSegurarTextBox" ToolTip="" SetFocusOnError="true">&otimes;</asp:RequiredFieldValidator>
                                            <asp:RangeValidator ID="rngValValorSegurarTextBox" ValidationGroup="Form" Display="Dynamic" runat="server" ControlToValidate="ValorSegurarTextBox" ToolTip="" SetFocusOnError="true" Type="Double" MinimumValue="0" MaximumValue="50000000">&otimes;</asp:RangeValidator>
                                        </td>
                                    </tr>
                                    <tr>
            ...
            <asp:Button ID="SimularSemGravar" ValidationGroup="Form" CssClass="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" runat="server" Text="Simular Sem Gravar" OnClick="SimularButton_Click" CausesValidation ="True"  />
            <asp:Button ID="SimularButton" ValidationGroup="Form" CssClass="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" runat="server" Text="Simular e Gravar" CommandName="Insert" CausesValidation ="True" OnClick="SimularButtonGravar_Click"  />
             
            <asp:Button ID="ConverterButton" CssClass="ui-button ui-widget ui-state-default ui-corner-all ui-button-text-only" runat="server"  ValidationGroup="Apolice" Text="Converter em Apólice"  Visible="true" OnClick="ConverterButton_Click" /><br />
    ...
    <div id="dialog-EmptyConverterApolice" title="Master Seguros" style="display: none">
        <br />Para converter numa apólice deve primeiro seleccionar a opção 'Simular e Gravar'.
    </div>
    <div id="dialog-ResultadoConverterApolice" title="Master Seguros" style="display: none">
        <br />A proposta foi convertida com sucesso.<br />
   ...
   <script type="text/javascript">
       ...
       function MessageBoxResultado(Apolice, Cliente) {
