<%@ Page Title="Clientes" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ValidaCliente.aspx.cs" Inherits="MASTERSEGUROS.WEB.ValidaCliente" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <h3>Clientes > Validar Clientes</h3>
    <br />
                ...
                <tr>
                    ...
                    <td>
                        <asp:DropDownList runat="server"  ID="EstadoComboBox" AutoPostBack ="false" AppendDataBoundItems="true" >
                            ...
                            <asp:ListItem Value="2" Text="Por Validar" Selected="false"></asp:ListItem>                          
                        </asp:DropDownList>
