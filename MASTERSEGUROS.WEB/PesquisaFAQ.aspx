<%@ Page Title="CMSCK - Gestor de Conteúdos" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="PesquisaFAQ.aspx.cs" Inherits="MASTERSEGUROS.WEB.PesquisaFAQ" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <asp:ScriptManager ID="ScriptManager1" runat="server"></asp:ScriptManager>
    <h3>FAQs > Pesquisa de FAQs</h3>
    <br />
   <asp:UpdatePanel ID="UpdatePanel2" runat="server"> 
        ...
        <table border="0" cellpadding="3" cellspacing="0" style="vertical-align: top">
                            <tr>
                                <td>ID FAQ:</td>
                                <td>
                                    <asp:TextBox ID="FAQIDTextBox" runat="server"  Width="30" MaxLength="4" />&nbsp;&nbsp;ID Classificador:&nbsp;<asp:TextBox ID="ClassificadorIDTextBox" runat="server" Width="30" MaxLength="4" />
        ...
        <div id="dialog-confirmDeleteFAQ" title="CMSCK" style="display: none">
        <br />
        <b>Tem a certeza que pretende remover o FAQ?</b>
    </div>

        <asp:GridView ID="GridViewFAQs" runat="server"
        AllowPaging="True" AutoGenerateColumns="False"
        CellPadding="2" DataKeyNames="FAQID,Lingua" DataSourceID="SqlDataSourceFAQ"
        ...
        <Columns>
            <asp:BoundField DataField="FAQID" HeaderText="ID" SortExpression="FAQID" ItemStyle-Width="50px" />
            ...
            <asp:TemplateField HeaderText="Estado" SortExpression="Estado" ItemStyle-HorizontalAlign="Center" ItemStyle-Width="50px">
                <ItemTemplate>  
                    <asp:ImageButton runat="server" ID="imgEstado" OnClick="imgEstado_Click" Estado='<%#(object)Eval("Estado")%>' IDFAQ='<%#(object)Eval("FAQID")%>' IDLingua='<%#(object)Eval("Lingua")%>'  ImageUrl='<%# BuildEstado((object)Eval("Estado"))%>' ToolTip='<%# BuildToolTipEstado((object)Eval("Estado"),(object)Eval("Titulo"))%>' />
                </ItemTemplate>
             </asp:TemplateField>
             ...
             <asp:TemplateField HeaderText="Operações" ItemStyle-HorizontalAlign="Center">
                <ItemTemplate>
                    <asp:DropDownList runat="server" ID="ddlOperation" AutoPostBack="true" IDFAQ='<%#(object)Eval("FAQID")%>' IDLingua='<%#(object)Eval("Lingua")%>' AppendDataBoundItems="true" Font-Size="12px"  onchange="javascript:if (this.value=='0') {return false;} if (this.value=='2') {return ConfirmDeleteFAQ(this);} else {true; }" OnSelectedIndexChanged="Operation_SelectedIndexChanged">
                        ...
                        <asp:ListItem Text="Pergunta|Resposta" Value="5"></asp:ListItem>
   ...
   <asp:SqlDataSource ID="SqlDataSourceFAQ" OnUpdated="On_Updated"  OnInserted="On_Inserted" runat="server"
        ConnectionString="<%$ ConnectionStrings:DBConnectionString %>"
        SelectCommandType="StoredProcedure" SelectCommand="spGetListFAQ">
       <SelectParameters>
           <asp:ControlParameter ControlID="FAQIDTextbox" PropertyName="Text" Name="FAQID" Type="Int32" DefaultValue="-1" />
   ...
   <script type="text/javascript">
    ...
    function ConfirmDeleteFAQ(obj) {
        $("#dialog-confirmDeleteFAQ").dialog({
